...
export const ProjectsDashboardPage = () => {
  ...
  const { data: eventsData, error: eventsError, loading: eventsLoading } = useFetchOrganizedEventsData();
  ...
  const { userData, userLoading: profileLoading } = useFetchUserProfile();
